...
class SimpleGoal : Goal
{
    ...
    public SimpleGoal(string name, string description, int pointValue, int total, bool isComplete)
    ...
    {
        string saveString =
            $"SimpleGoal|{_name}|{_description}|{_pointValue}|{_totalPoints}|{_isComplete}";
        return saveString;
    }
}
