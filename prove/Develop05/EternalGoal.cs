class EternalGoal : Goal
{
    ...
    public EternalGoal(string name, string description, int pointValue, int total, bool isComplete):base(name, description, pointValue, total, isComplete){}
    ...
    {
        string saveString = $"EternalGoal|{_name}|{_description}|{_pointValue}|{_totalPoints}|{_isComplete}";
        return saveString;
    }
}